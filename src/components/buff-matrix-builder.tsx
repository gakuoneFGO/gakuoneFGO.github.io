...
import { Table, TableCell, TableContainer, TableRow, Tooltip, Box, ButtonGroup, Button, Typography, IconButton, Stack, useMediaQuery, capitalize, TableBody } from "@mui/material";
...
function BuffMatrixBuilder(props: BuffMatrixBuilderProps) {
    ...
    return (
        <TableContainer>
            <Table>
                <TableBody>
                    <TransposedTable createRow={(children, index) => <TableRow key={index}>{children}</TableRow>}>
                        <TableRow>
                            <TableCell>
